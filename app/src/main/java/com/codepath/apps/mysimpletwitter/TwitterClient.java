...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "gfQlJFtPNSfbccDZQ6TkLl0Kt";       // Change this
    public static final String REST_CONSUMER_SECRET = "4CSj2fxVLZ79TrDaorSQr9yemBdgCEIywmjvh9f7yHYM3WlTTE"; // Change this
    ...
    */
    ...
    public void getUserUserInfo(JsonHttpResponseHandler handler) {
        String apiUrl = getApiUrl("account/verify_credentials.json");
        getClient().get(apiUrl, null, handler);
    }
    //have new methonds for every activity
